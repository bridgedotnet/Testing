...
declare namespace Generics {
    ...
    interface GenericNamedEntity$1Func extends Function {
        <T>($T: Bridge.TypeRef<T>): {
            ...
            new (instance: T | null): GenericNamedEntity$1<T>;
        }
    }
    ...
    interface GenericNewAndClass$1Func extends Function {
        <T>($T: Bridge.TypeRef<T>): {
            ...
            new (instance: T | null): GenericNewAndClass$1<T>;
        }
    }
    ...
    interface GenericClass$1Func extends Function {
        <T>($T: Bridge.TypeRef<T>): {
            ...
            new (instance: T | null): GenericClass$1<T>;
        }
    }
    ...
    interface implementationFunc extends Function {
        ...
        new (): implementation;
        SimpleGenericInt: Generics.SimpleGeneric$1<number> | null;
        SimpleDoubleGenericIntString: Generics.SimpleDoubleGeneric$2<number,string> | null;
        GenericINamedEntity: Generics.GenericINamedEntity$1<Generics.INamedEntity> | null;
        GenericNamedEntity: Generics.GenericNamedEntity$1<Generics.NamedEntity> | null;
        GenericClassObject: Generics.GenericClass$1<any> | null;
        GenericClassNamedEntity: Generics.GenericClass$1<Generics.NamedEntity> | null;
        GenericNew: Generics.GenericNew$1<Generics.NewClass> | null;
        GenericNewAndClass: Generics.GenericNewAndClass$1<Generics.NewClass> | null;
    }
