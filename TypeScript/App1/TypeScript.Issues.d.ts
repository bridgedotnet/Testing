...
declare namespace TypeScript.Issues {
    ...
    module N1640 {
        interface GamePlay extends TypeScript.Issues.N1640.IGamePlay {
            addOnGameEvent(value: {(sender: any, e: string): void} | null): void;
            removeOnGameEvent(value: {(sender: any, e: string): void} | null): void;
            StartGame(s: string | null): void;
            Subscribe(handler: {(sender: any, e: string): void} | null): void;
        }
        ...
        interface IGamePlay {
            TypeScript$Issues$N1640$IGamePlay$addOnGameEvent(value: {(sender: any, e: string): void} | null): void;
            TypeScript$Issues$N1640$IGamePlay$removeOnGameEvent(value: {(sender: any, e: string): void} | null): void;
            addOnGameEvent(value: {(sender: any, e: string): void} | null): void;
            removeOnGameEvent(value: {(sender: any, e: string): void} | null): void;
            TypeScript$Issues$N1640$IGamePlay$StartGame(s: string | null): void;
            StartGame(s: string | null): void;
        }
    }
    ...
    module N1060 {
        interface B$1<T> {
            GetC(): TypeScript.Issues.N1060.B$1.C<T> | null;
        }
    ...
    interface N2031DictionaryMap$2<T1,T2> {
        Forward: TypeScript.Issues.N2031DictionaryMap$2.Indexer$2<T1,T2,T1,T2> | null;
        Reverse: TypeScript.Issues.N2031DictionaryMap$2.Indexer$2<T1,T2,T2,T1> | null;
    ...
    interface N2031DictionaryMap$2Func extends Function {
        <T1, T2>($T1: Bridge.TypeRef<T1>, $T2: Bridge.TypeRef<T2>): {
            ...
            $ctor1: {
                new (initialValues: System.Collections.Generic.KeyValuePair$2<T1,T2>[] | null): N2031DictionaryMap$2<T1,T2>
            };
        }
    }
    ...
    module N2031DictionaryMap$2 {
        ...
        interface Indexer$2Func extends Function {
            <T1, T2, T3, T4>($T1: Bridge.TypeRef<T1>, $T2: Bridge.TypeRef<T2>, $T3: Bridge.TypeRef<T3>, $T4: Bridge.TypeRef<T4>): {
                ...
                new (dictionary: System.Collections.Generic.Dictionary$2<T3,T4> | null): Indexer$2<T1,T2,T3,T4>;
            }
        }
    }
    ...
    module N3061 {
        ...
        interface Car extends TypeScript.Issues.N3061.IVehicle,System.IEquatable$1<TypeScript.Issues.N3061.Car> {
            Horses: number;
            equalsT$1(vehicle: TypeScript.Issues.N3061.IVehicle | null): boolean;
            equalsT(car: TypeScript.Issues.N3061.Car | null): boolean;
        }
    ...
    interface N2911Func extends Function {
        prototype: N2911;
        new (): N2911;
        initButton_Clicked(arg: MouseEvent | null): void;
    }
    var N2911: N2911Func;
    ...
    interface N2264Func extends Function {
        prototype: N2264;
        new (queryParameters: System.Collections.Generic.IEnumerable$1<string> | null): N2264;
    }
    var N2264: N2264Func;
    ...
    interface N2661C {
        fn: {(x: TypeScript.Issues.N2661C): Function} | null;
    }
    ...
    interface N2463Func extends Function {
        prototype: N2463;
        new (): N2463;
        Do(dummy: {Nothing: number} | null): {Nothing: number} | null;
    }
    var N2463: N2463Func;
    module N2463 {
    }
