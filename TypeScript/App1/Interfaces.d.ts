...
declare namespace Interfaces {
    interface Interface3 extends Interfaces.Interface2 {
        Interfaces$Interface3$Method5(i: Interfaces.Interface3 | null): Interfaces.Interface2 | null;
        Method5(i: Interfaces.Interface3 | null): Interfaces.Interface2 | null;
    }

    interface Class2 extends Interfaces.Class1,Interfaces.Interface2 {
        Method1(): void;
        Method2(s: string | null): void;
        Method3(): number;
        Method4(i: Interfaces.Interface1 | null): boolean;
    }
    ...
    interface Class6 extends Interfaces.Interface6 {
        ...
        GetProperty(): number;
        SetProperty$1(s: string | null): void;
    ...
    interface Class4 extends Interfaces.Interface4 {
        ...
        Method8(s: {v: string | null}): void;
        Method9(i: number, s: {v: string | null}): void;
        Method10(i: number, b: {v: boolean}, s: {v: string | null}): void;
    }
    ...
    interface Interface2 extends Interfaces.Interface1 {
        ...
        Method1(): void;
        Interfaces$Interface2$Method2(i: string | null): void;
        Method2(i: string | null): void;
        Interfaces$Interface2$Method3(): number;
        Method3(): number;
        Interfaces$Interface2$Method4(i: Interfaces.Interface1 | null): boolean;
        Method4(i: Interfaces.Interface1 | null): boolean;
    }
    ...
    interface Interface4 {
        ...
        Method7(i: number, b: {v: boolean}): void;
        Interfaces$Interface4$Method8(s: {v: string | null}): void;
        Method8(s: {v: string | null}): void;
        Interfaces$Interface4$Method9(i: number, s: {v: string | null}): void;
        Method9(i: number, s: {v: string | null}): void;
        Interfaces$Interface4$Method10(i: number, b: {v: boolean}, s: {v: string | null}): void;
        Method10(i: number, b: {v: boolean}, s: {v: string | null}): void;
    }
    ...
    interface Interface6 {
        ...
        GetProperty(): number;
        Interfaces$Interface6$SetProperty$1(s: string | null): void;
        SetProperty$1(s: string | null): void;
    ...
    interface Interface62 {
        ...
        GetProperty(): number;
        Interfaces$Interface62$SetProperty$1(s: string | null): void;
        SetProperty$1(s: string | null): void;
